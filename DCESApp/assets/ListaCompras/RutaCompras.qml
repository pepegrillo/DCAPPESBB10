...
Page {
            ...
            Container {
                ...
                Container {
                    ...
                    Label {
                        ...
                        text: qsTr("Ruta de Compras") + Retranslate.onLocaleOrLanguageChanged
    ...
    actions: [
        ActionItem {
            ...
            onTriggered: {
                var crearestablecimiento  = crearestablecimiento_page.createObject();
                //crearlista.hashkeyN = hashkey;
                //crearlista.vuserN	= vuser;
                
                nPMenuDC.push(crearestablecimiento);
            }
    ...
    attachedObjects: [
        ...
        ComponentDefinition {
            id: crearestablecimiento_page
            source: "MunicipioCompras.qml"
        },
        GroupDataModel {
            id: dataModel
        ...
        DataSource {
            id: dataSource
            remote: true
            source: "http://observatoriodeprecios.defensoria.gob.sv/ApiREST.php/v1/getEstablecimientosAgregadosRuta/"+idLista+"/"+hashkey;
        ...
        SystemToast {
            id: okSuccess
            body: "Tu establecimiento se ha eliminado satisfactoriamente."
        
        },
        SystemToast {
            id: error
            body: "Tu establecimiento no se ha podido eliminar. Intenta más tarde."
        
        },
        SystemDialog {
            
            id: dialog
            title: qsTr("Eliminar Establecimiento")
            body: qsTr("")
            ...
            onFinished: {
                ...
                if (x == SystemUiResult.ConfirmButtonSelection) {
                    Data.deleteAgregarEst(hashkey,idLista,idEstablecimiento);
