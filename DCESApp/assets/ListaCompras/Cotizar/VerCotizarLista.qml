...
Page {
            ...
            Container {
                ...
                Container {
                    ...
                    Label {
                        ...
                        text: qsTr("Establecimientos") + Retranslate.onLocaleOrLanguageChanged
            ...
            Container {                
                ...
                ListView {
                    ...
                    onTriggered: {
                        ...
                        cotizarlista.idestablecimiento = chosenItem.idestablecimiento;
    ...
    actions: [
        ActionItem {
            ...
            onTriggered: {
                var mapa = mapa_page.createObject();
                mapa.hashkey = hashkey;
                mapa.idlista = idlista;
                nPMenuDC.push(mapa);
    ...
    attachedObjects: [
        ...
        ComponentDefinition {
            ...
            source: "VerCotizarListaDetalle.qml"
        },
        ComponentDefinition {
            id: mapa_page
            source: "Mapa.qml"
        ...
        DataSource {
            id: dataSource
            remote: true
            source: "http://observatoriodeprecios.defensoria.gob.sv/ApiREST.php/v1/getCotizacionEstablecimientosLista/"+hashkey+"/"+idlista;
