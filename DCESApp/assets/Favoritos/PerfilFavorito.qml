            ...
            ScrollView {
                ...
                Container {
                    ...
                    Container {
                        ...
                        Label {
                            // Localized text with the dynamic translation and locale updates support
                            text: qsTr("Establecimiento: "+establecimientoN) + Retranslate.onLocaleOrLanguageChanged
                            textStyle.base: SystemDefaults.TextStyles.TitleText
                            horizontalAlignment: HorizontalAlignment.Left
                            textStyle.color: Color.create("#ea7529")
                            multiline: true
    ...
    actions: [
        ActionItem {
            ...
            onTriggered: {
                ...
                Data.deleteFavoritos(hashkeyN,idarticuloN,"2");
                                
            }
            imageSource: "asset:///images/btnFav1.png"
        }
    ]
    attachedObjects: [
        ...
        ComponentDefinition {
            id: detalleF_page
            source: "Favoritos.qml"
        },
        SystemToast {
            id: waitFavoritos
            body: "Eliminando de favoritos..."
        },
        SystemToast {
            id: dtFavoritos
            body: "Producto eliminado de favoritos exitosamente."
        }
